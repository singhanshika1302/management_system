  ...
  class _QuestionAreaState extends State<QuestionArea> {
    ...
    Future<void> _handleTickIconPressed() async {
      ...
      setState(() {
        ...
        _areOptionsValid = updatedOptions.map((option) => option['desc'].isNotEmpty as bool).toList();
        _isCorrectAnswerValid = updatedCorrectAnswer.isNotEmpty;
        _isExplanationValid = updatedExplanation.isNotEmpty;
      });

      if (_isQuestionValid && _areOptionsValid.every((valid) => valid) && _isCorrectAnswerValid && _isExplanationValid) {
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                  color: widget.correctAnswer == widget.options[index]['id'] ? primaryColor : Colors.black,
                                  width: 2,
                                ),
                              ),
